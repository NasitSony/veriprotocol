...
- Event-driven Proposal -> Vote -> Commit flow
- Added metrics
- Added decision latency measurement

## Observations

- Consensus reached under FIFO and Random schedulers
- Scheduler affects decision delivery count
